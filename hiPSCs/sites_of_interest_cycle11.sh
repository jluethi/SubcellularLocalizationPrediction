...
ln $base_path$cycle$path_part2'undifferentiated/'$img_name'T0001F'$site*'C04.png' $target_base_path$cycle
...
ln $base_path$cycle$path_part2'start_differentiation/'$img_name'T0002F'$site*'C04.png' $target_base_path$cycle
...
ln $base_path$cycle$path_part2'differentiated/'$img_name'T0003F'$site*'C04.png' $target_base_path$cycle
...
# For cycle 11: Also copy C04 and rename to C02.
rename 's/A03/A01/' '201909'*
rename 's/C04/C02/' '201909'*