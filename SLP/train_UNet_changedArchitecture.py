...
def train_UNet_large_kernel(input_channels, output_channel):
    ##################################
    # General parameters
    ##################################
    batch_size = 8
    ...
    filename_base = datetime.datetime.today().strftime('%Y%m%d') +'SLP_SubcellularLoss_Rescaling_' + str(rescaling) + \
                    '_Input_' + filename_input_channels + 'Predicting_' + channel_names[
        output_channel[0]]
    ...
    encode1 = Conv2D(16, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer1_1')(encode1)
    encode1 = BatchNormalization(axis=-1, name='BatchN_Layer1_2')(encode1)
    encode1 = Conv2D(16, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer1_2')(encode1)
    encode1 = BatchNormalization(axis=-1, name='BatchN_Layer1_3')(encode1)
    encode1 = Conv2D(16, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer1_3')(encode1)
    ...
    encode2 = Conv2D(32, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer2_1')(encode2)
    encode2 = BatchNormalization(axis=-1, name='BatchN_Layer2_2')(encode2)
    encode2 = Conv2D(32, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer2_2')(encode2)
    ...
    encode3 = Conv2D(64, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer3_1')(encode3)
    encode3 = BatchNormalization(axis=-1, name='BatchN_Layer3_2')(encode3)
    encode3 = Conv2D(64, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer3_2')(encode3)
    ...
    encode4 = Conv2D(128, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer4_1')(encode4)
    encode4 = BatchNormalization(axis=-1, name='BatchN_Layer4_2')(encode4)
    encode4 = Conv2D(128, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer4_2')(encode4)
    ...
    encode5 = Conv2D(256, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer5_1')(encode5)
    encode5 = BatchNormalization(axis=-1, name='BatchN_Layer5_2')(encode5)
    encode5 = Conv2D(256, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer5_2')(encode5)
    encode5 = BatchNormalization(axis=-1, name='BatchN_Layer5_3')(encode5)
    encode_5 = Conv2D(512, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Encode_Layer5_3')(encode5)

    # Decoder
    # Fifth Decoder layer 40x40
    encode5 = BatchNormalization(axis=-1, name='BatchN_Decode_Layer5_1')(encode5)
    decode_5 = Conv2D(256, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer5_1')(encode_5)
    ...
    decode_4 = Conv2D(128, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer4_1')(decode_4)
    decode_4 = BatchNormalization(axis=-1, name='BatchN_Decode_Layer4_2')(decode_4)
    decode_4 = Conv2D(128, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer4_2')(decode_4)
    ...
    decode_3 = Conv2D(64, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer3_1')(decode_3)
    decode_3 = BatchNormalization(axis=-1, name='BatchN_Decode_Layer3_2')(decode_3)
    decode_3 = Conv2D(64, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer3_2')(decode_3)
    ...
    decode_2 = Conv2D(32, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer2_1')(decode_2)
    decode_2 = BatchNormalization(axis=-1, name='BatchN_Decode_Layer2_2')(decode_2)
    decode_2 = Conv2D(32, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer2_2')(decode_2)
    ...
    decode_1 = Conv2D(16, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer1_1')(decode_1)
    decode_1 = BatchNormalization(axis=-1, name='BatchN_Decode_Layer1_2')(decode_1)
    decode_1 = Conv2D(16, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer1_2')(decode_1)
    decode_1 = BatchNormalization(axis=-1, name='BatchN_Decode_Layer1_3')(decode_1)
    decoded = Conv2D(1, (kernel_size, kernel_size), activation='relu', padding='same', name='Conv2D_Decode_Layer1_3')(decode_1)
